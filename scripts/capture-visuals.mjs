...
const captures = [
    ...
    { name: "previous-instances-world", path: "/favorite/worlds", readyText: "You", favoriteKind: "world", worldDialog: true, previousInstances: "world" },
    ...
    { name: "previous-instances-group", path: "/", readyText: "You", groupDialog: true, previousInstances: "group" },
