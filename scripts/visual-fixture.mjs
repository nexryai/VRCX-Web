...
await database.collection("group_members").insertMany([
    ...
    },
    {
        ...
        groupId: "grp_00000000-0000-0000-0000-000000000020",
        userId: friends[0].id,
        member: { id: "gmem_visual_aoi", groupId: "grp_00000000-0000-0000-0000-000000000020", userId: friends[0].id, roleIds: ["grol_00000000-0000-0000-0000-000000000021"], joinedAt: new Date(now.getTime() - 180 * 86_400_000).toISOString(), user: friends[0] },
        active: true,
        observedAt: now,
        updatedAt: now,
    },
