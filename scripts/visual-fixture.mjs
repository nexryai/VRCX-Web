...
await database.collection("notifications").insertMany([
    ...
    {
        _id: `${ownerId}:legacy:not_visual_invite_response`,
        ownerId,
        notificationId: "not_visual_invite_response",
        source: "legacy",
        notification: {
            id: "not_visual_invite_response",
            type: "inviteResponse",
            senderUserId: friends[1].id,
            senderUsername: friends[1].displayName,
            message: "Will join after this world.",
            seen: true,
            created_at: new Date(now.getTime() - 42 * 60_000).toISOString(),
            source: "legacy",
        },
        active: false,
        firstObservedAt: new Date(now.getTime() - 42 * 60_000),
        lastObservedAt: new Date(now.getTime() - 42 * 60_000),
        updatedAt: now,
    },
    {
